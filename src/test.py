...
#xinge.XingeHelper.SetServer('10.133.2.212')
#xinge.XingeHelper.SetServer('10.133.1.153')
#xinge.XingeHelper.SetServer('10.139.6.79')
#xinge.XingeHelper.SetServer('10.166.224.41')
#xinge.XingeHelper.SetServer('10.128.67.229')
#xinge.XingeHelper.SetServer('10.177.153.110')
#xinge.XingeHelper.SetServer('10.135.1.71')
#xinge.XingeHelper.SetServer('10.133.2.170')
#xinge.XingeHelper.SetServer('10.133.2.171')
#xinge.XingeHelper.SetServer('10.133.2.12')
#xinge.XingeHelper.SetServer('10.133.1.154')
#xinge.XingeHelper.SetServer('10.133.1.157')
#xinge.XingeHelper.SetServer('10.133.1.162')
#xinge.XingeHelper.SetServer('vipopenapi.xg.qq.com')

def TestPushToken():
    x = xinge.XingeApp(353, '353_secret_key')
    #x = xinge.XingeApp(100, 'key2')
    x = xinge.XingeApp(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b')
    #x = xinge.XingeApp(2100072080, 'ee88b194a5b6949f769c454d75e6b3e9')
    #x = xinge.XingeApp(2100000097, '50f3b708dc241503484c80996c3e46b3')
    #x = xinge.XingeApp(2100000105, '8131855e542e676348d77e4fbb7f58d3')
    #x = xinge.XingeApp(2100040684, '5d232659dc55e03f4df5a95587b0c64c')
    #x = xinge.XingeApp(2100038814, '74e636481463b7d57ea04956c096c4b4')
    #x = xinge.XingeApp(2190000354, 'xg354key')
    #x = xinge.XingeApp(2100034689, '05e37e44035deecad0bce6b3320d6991')
    #x = xinge.XingeApp(2194903379, '4578e54fb3a1bd18e0681bc1c734514e')
    msg = xinge.Message()
    ...
    ret = x.PushSingleDevice('16f4f363697c09a84642ab9145fae91bb46a223a', msg, xinge.XingeApp.ENV_DEV)    #ret = x.PushSingleDevice('bbbb3a7baae5b88f4ca89c583a54cd74337c284a', msg, xinge.XingeApp.ENV_DEV)
    #ret = x.PushSingleDevice('16ec008f123a7b444161a113f25c7ebcf0df1b09', msg, xinge.XingeApp.ENV_DEV)
    #ret = x.PushSingleDevice('4c0168514359ddae4879a48e3c76a46542920e80', msg, xinge.XingeApp.ENV_DEV)
    #ret = x.PushSingleDevice('c762a481feebc44f4b7b99d80482e0b1736ca263', msg, xinge.XingeApp.ENV_DEV)
...
def TestPushTokenIos():
    ...
    #x = xinge.XingeApp(2200003965, '13cf9e99db5bc421dec3d78889e806e5')
    #msg = xinge.Message()
    msg = xinge.MessageIOS()
    ...
    ti = xinge.TimeInterval(20, 0, 23, 0)
    msg.acceptTime = (ti,)
    ...
    for i in range(1):
    #for i in range(0,4):
        ret = x.PushSingleDevice('b7a048d9e24c1101ed54dfe39f9434aaa956942673e76efe566a45005dc6d3c9', msg, xinge.XingeApp.ENV_PROD)
...
def TestPushAll():
    x = xinge.XingeApp(100, 'key2')
    x = xinge.XingeApp(354, '354_secret_key')
    #x = xinge.XingeApp(248248, '248248SecretKey')
    x = xinge.XingeApp(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b')
    #x = xinge.XingeApp(2100000097, '50f3b708dc241503484c80996c3e46b3')
    #x = xinge.XingeApp(2293757609, 'c35a0de6e38ecb0981863d7d796b8078')
    msg = xinge.Message()
    msg.type = xinge.Message.TYPE_MESSAGE
    msg.type = xinge.Message.TYPE_NOTIFICATION
    ...
    #msg.raw = '{"xg_max_payload":1,"accept_time":[{"start":{"hour":"20","min":"0"},"end":{"hour":"23","min":"59"}}],"aps":{"alert":"==========================================================================================================================================================================================================================================="}}'
    #msg.sendTime = '2014-03-12 18:21:00'
    ti = xinge.TimeInterval(20, 0, 23, 59)
    msg.acceptTime = (ti,)
...
def TestQueryDeviceNum():
    x = xinge.XingeApp(100, 'key2')
    x = xinge.XingeApp(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b')
    #x = xinge.XingeApp(2100048042, '03c6562ef2094a63703c5b448e10cc93')
    x = xinge.XingeApp('2100034398', 'b5d3e21bea00c8aa5fac1fabb5cf058f')
...
def TestBatchSetTag():
    ...
    x = xinge.XingeApp(100, 'key2')
    x = xinge.XingeApp(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b')
    #x = xinge.XingeApp(2100046563, '40b9a2e1c25a0cc3cf50bb65839b3ec1')
    pairs = [xinge.TagTokenPair(('tag%d' % i),'16f4f363697c09a84642ab9145fae91bb46a223a') for i in range(2)]
    #pairs = [xinge.TagTokenPair('user_opc','2435bec3a63d21d94bf88234818e45ada6d91f60'),xinge.TagTokenPair('user_tester','2435bec3a63d21d94bf88234818e45ada6d91f60')]
...
def TestBatchDelTag():
    ...
    x = xinge.XingeApp(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b')
    #x = xinge.XingeApp(2100046563, '40b9a2e1c25a0cc3cf50bb65839b3ec1')
    pairs = [xinge.TagTokenPair(('tag%d' % i),'2435bec3a63d21d94bf88234818e45ada6d91f60') for i in range(2)]
    pairs = [xinge.TagTokenPair('user_opc','2435bec3a63d21d94bf88234818e45ada6d91f60'),xinge.TagTokenPair('user_tester','2435bec3a63d21d94bf88234818e45ada6d91f60')]
...
if '__main__' == __name__:
    ...
    #print xinge.PushTokenAndroid(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b', 'title token', 'content', '16f4f363697c09a84642ab9145fae91bb46a223a')
    #print xinge.PushAccountAndroid(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b', 'title account', 'content', '241008')
    #print xinge.PushAllAndroid(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b', 'title all', 'content')
    #print xinge.PushTagAndroid(2100001752, '7c526a5e2ff5b61f4f635c1b0b86214b', 'title tag', 'content', 'new')
 
    #print xinge.PushTokenIos(101, 'skey', 'content', 'b7a048d9e24c1101ed54dfe39f9434aaa956942673e76efe566a45005dc6d3c9', xinge.XingeApp.ENV_DEV)
    #print xinge.PushAccountIos(101, 'skey', 'content', '241008', xinge.XingeApp.ENV_DEV)
    #print xinge.PushAllIos(101, 'skey', 'content', xinge.XingeApp.ENV_DEV)
    #print xinge.PushTagIos(101, 'skey', 'content', 'new', xinge.XingeApp.ENV_DEV)
